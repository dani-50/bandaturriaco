...
export const galleryEvents: GalleryEvent[] = [
  {
    ...
    media: [
      ...
      { type: 'image', src: '/asset/gallery/beneficenza/foto1.png' },
      ...
      { type: 'video', src: '/asset/gallery/beneficenza/video5.mp4' },
      ...
      { type: 'image', src: '/asset/gallery/beneficenza/foto18.jpeg' },
      { type: 'image', src: '/asset/gallery/beneficenza/foto4.jpeg' },
      { type: 'image', src: '/asset/gallery/beneficenza/foto17.jpeg' },
      ...
      { type: 'image', src: '/asset/gallery/beneficenza/foto16.jpeg' },
  ...
  },
  {
    ...
    coverImg: '/asset/gallery/concorso_bertiolo/concorso_brano1.mp4',
    it: { title: "Concorso bandistico", place: "Bertiolo" },
    en: { title: "Wind Band Competition", place: "Bertiolo" },
    de: { title: "Blasmusik Wertungsspiel" , place: "Bertiolo" },
    media: [
      { type: 'video', src: '/asset/gallery/concorso_bertiolo/concorso_brano1.mp4', caption: 'Porceddu: Golden Suite' },
      { type: 'video', src: '/asset/gallery/concorso_bertiolo/concorso_brano2.mp4', caption: 'Agnello: Frost Rhapsody' },
    ],
  },
];
